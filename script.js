...
input.setAttribute("placeholder","Enter the No. of Kural");
...
async function foo(){
    ...
    chapter.innerHTML=`<b><u>Chapter Group-Tamil</u></b>: ${result1.chapgrp_tam}`
    ...
    chapgroup.innerHTML=`<b><u>Chapter Group-English</u></b>: ${result1.chapgrp_eng}`
